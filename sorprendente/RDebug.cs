    ...
    public sealed class RDebug
    {
        ...
        public static void Start()
        {
            lock (m_SyncRoot)
            {
                ...
                m_Mutex = new Mutex(false, typeof(RDebug).Namespace, out createdNew);
                if (!createdNew)
        ...
        private static void Capture()
        {
            try
            {
                ...
                IntPtr pString = new IntPtr(m_SharedMem.ToInt32() + Marshal.SizeOf(typeof(int)));
